...
export class UserList {
    ...
    locationmodal() {
        ...
        // if (this.pageParams.latitude  && this.pageParams.longitude ) {
        //     pageData = { latitude: this.pageParams.latitude, longitude: this.pageParams.longitude };
        // }
        let modal = this.modalCtrl.create(GetLocation, {pageData:{comeFrom:'userList'}});
        modal.onDidDismiss((data) => {
          console.log('map data from modal', data);
          if (data && data.latitude && data.longitude) {
            //console.log(data);
            this.pageParams.latitude = data.latitude;
            this.pageParams.longitude = data.longitude;
