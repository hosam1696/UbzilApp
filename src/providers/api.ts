...
export class API {
  ...
  constructor(public http: Http) {
    ...
    this.SystemGateway = 'http://bawabt-alnagel.com/api/v1/'; // System API Link
    this.SMSGateway    = 'http://localhost/AlBawabh/api/sendSMS.php'; // SMS Gateway
    ...
    this.getRoutes    = this.SystemGateway+'node?parameters[type]=routes'; // get Routes list
