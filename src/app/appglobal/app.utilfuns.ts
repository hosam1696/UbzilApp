...
export class AppUtilFunctions {
    //public ApiUrl: string = 'http://localhost/ubzil/api/';
    ...
    public get UPLOAD_FOLDER() {
        return 'http://localhost/ubzil/templates/default/uploads/';
        //return 'http://ubzil.com/templates/default/uploads/';
